...
void HD44780::init(I2C * i2cPort, Gpio * backLightPin, Gpio * resetLCDPin){
...
bool HD44780::sendCommand(uint8_t cmd){
...
bool HD44780::sendData(uint8_t data){
  return sendCmdOrData(false, data);
}


bool HD44780::sendLine(uint32_t lineNr){
  getDataFifo()->flush();
  getDataFifo()->put(DATA);
